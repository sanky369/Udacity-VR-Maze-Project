...
public class lightUp : MonoBehaviour {
	...
	void Start () {
		...
		//ps.EmissionModule.enabled = false; //Start without emitting particles
	...
	public void gazeLightUp() {
		...
		//ps.EmissionModule.enabled = true; //Turn on particle emmission
	...
	public void aestheticReset() {
		...
		//ps.EmissionModule.enabled = false; //Turn off particle emission
	}
